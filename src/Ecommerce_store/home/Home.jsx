  ...
  return (
    <div className="home">
      <motion.div className="main-text flex flex-col gap-4 md:gap-7">
        <div className="text-lg md:text-2xl font-semibold tracking-widest text-customBlack sm:text-customWhite">
          SPECIAL PROMO
        </div>
        <motion.div 
          ...
          <motion.span variants={childVariants} className="text-5xl low:text-6xl sm:text-7xl md:text-8xl 2xl:text-9xl font-bold text-white tracking-tighter">
            START
          </motion.span>
          <motion.span variants={childVariants} className="text-5xl low:text-6xl sm:text-7xl md:text-8xl 2xl:text-9xl font-bold text-white tracking-tighter">
            SHOPPING
